...
//	buttonRectShow = (isPortrait) ? CGRectMake(0.00f, 514.00f, 105.00f, 53.00f) : CGRectMake(0.00f, 281.00f, 158.00f, 39.00f);
//	buttonRectHide = (isPortrait) ? CGRectMake(0.00f, 644.00f, 105.00f, 53.00f) : CGRectMake(0.00f, 443.00f, 158.00f, 39.00f);
	...
	if(isPortrait)
    {
        if(IsIphone5)
        {
            buttonRectShow = CGRectMake(0.00f, 515.00f, 105.00f, 53.00f);
            buttonRectHide = CGRectMake(0.00f, 644.00f, 105.00f, 53.00f);
        }
        else
        {
            buttonRectShow = CGRectMake(0.00f, 427.00f, 105.00f, 53.00f);
            buttonRectHide = CGRectMake(0.00f, 644.00f, 105.00f, 53.00f);
        }
    }
    //Change frames when application supports to landsacpe mode.
    else
    {
        if(IsIphone5)
        {
            buttonRectShow = CGRectMake(0.00f, 515.00f, 105.00f, 53.00f);
            buttonRectHide = CGRectMake(0.00f, 443.00f, 158.00f, 39.00f);
        }
        else
        {
            buttonRectShow = CGRectMake(0.00f, 427.00f, 105.00f, 53.00f);
